...
<!-- Custom Theme files -->
<script src="{{ asset('asset/css/jquery-1.12.0.min.js') }}"></script>
...
<link href="{{ asset('asset/css/animate.css') }}" rel="stylesheet" type ="text/css" media="all">
...
<?php 
foreach($data_place as $result)
{	?>
			<div class="rom-btm">
				<div class="col-md-3 room-left wow fadeInLeft animated" data-wow-delay=".5s">
					<img src="admin/pacakgeimages/<?php echo htmlentities($result->place_picture);?>" class="img-responsive" alt="">
				</div>
				<div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
					<h4>Place Name: <?php echo htmlentities($result->place_name);?></h4>
					<h6>Place Description : <?php echo htmlentities($result->place_description);?></h6>
					<p><b>Place Ratings :</b> <?php echo htmlentities($result->place_ratings);?></p>
					<p><b>Page Viewer Count :</b> <?php echo htmlentities($result->page_viewer_count);?></p>
				</div>
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5>Stars <?php echo htmlentities($result->place_ratings);?></h5>
